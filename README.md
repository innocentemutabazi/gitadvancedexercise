...
```bash
  495  git stash
  496  git stash pop
  497  touch newfile.txt
  498  git add newfile.txt
  499  git commit -m "Add conflict file in main"
  500  git checkout -b ft/new-branch
  501  touch newfile.txt
  502  git add newfile.txt
  503  git commit -m "Add conflict file in newfile file"
  504  git checkout main
  505  git merge ft/new-branch
  506  git add newfile.txt
  507  git merge ft/new-branch
  508  git status
  509  git add newfile.txt
  510  git status
  511  git checkout ft/new-branch
  512  checkout main
  513  git checkout main
  514  git add .
  515  git status
  516  git commit -m "Create conflict on main"
  517  git checkout ft/new-branch
  518  git status
  519  git add .
  520  git status
  521  git commit -m "Create conflict on ft branch"
  522  git checkout main
  523  git merge ft/branch
  524  git add .
